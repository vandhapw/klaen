...
const FrontPage = ({ data, loading, area }) => {
    ...
    const dataButton = () => {
        if(area == "OUTDOOR AIR"){
            navigation.navigate('ChartOutdoor')
        }else if(area == "INDOOR AIR"){
            navigation.navigate('ChartIndoor')
        }else {
            navigation.navigate('ChartWeather')
        }
    }
        ...
        <View style={styles.container}>
            ...
            <View style={{position:'absolute', flex:1, flexDirection:'row', top:'40%'}}>
                ...
                <View style={{marginStart: 50}}>
                    <TouchableOpacity onPress={() => dataButton()}>
                        <Text>Chart</Text>
                    </TouchableOpacity>
                </View>
