...
const IndexKlaen = ({ navigation }) => {
            ...
            >
                ...
                <View style={[{
                    ...
                    <View style={{ height: '35%', justifyContent: 'space-between' }}>
                        <Text style={{ color: COLORS.white, ...FONTS.body4 }}>{item.level}</Text>
                        <Text style={{ color: COLORS.white, ...FONTS.body4 }}>{item.last_on}</Text>
                        <Text style={{ color: COLORS.white, ...FONTS.body4 }}>{item.average_usage}</Text>
        ...
        return (
            ...
            >
                <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
                    {/* <Image
                        source={require('../../assets/images/klaen.png')}
                        resizeMode="cover"
                        style={{
                            width: 130,
                            height: 100,
                ...
                <View style={{ flex: 1.5, marginLeft: SIZES.radius, justifyContent: "center" }}>
                    <Text style={{ color: COLORS.gray, ...FONTS.body3 }}>{item.level}</Text>
                    <Text style={{ color: COLORS.gray, ...FONTS.body3 }}>{item.last_on}</Text>
                    <Text style={{ color: COLORS.gray, ...FONTS.body3 }}>{item.average_usage}</Text>
    ...
    return (
        <View style={styles.container}>
            <Text style={{ marginTop: SIZES.radius, marginHorizontal: SIZES.padding, ...FONTS.largeTitleBold }}>HISTORY USAGE</Text>
            ...
            >
                ...
                <View style={{ flex:1, flexDirection:'column'}}>
                    <View style={{marginStart: '25%', flex: 1, flexDirection:'row', marginBottom:40, marginTop:5, marginEnd:10}}>
                        <View style={{marginStart:'70%'}}>
                        <TouchableOpacity>
                        <IconLabel icon={icons.plus} />
                        {/* <Text style={{paddingBottom:50, position:'relative'}}>Setting Device</Text> */}
                        </TouchableOpacity>
                        </View>
                    ...
                    <View style={{marginStart: '25%', marginTop:75,position:'absolute'}}>
                        <Text>Current Status</Text>
                    </View>
                    <View style={{marginStart: '25%', marginTop: '35%', position:'absolute', width:'70%', justifyContent:'center'}}>
                        ...
                        <View style={{paddingTop: 15}}>
                            <TouchableOpacity>
                                <Card>
                                    <Text>Total Usage : 10 h</Text>
                                    <Text>Average per Day : </Text>
                                </Card>
                            </TouchableOpacity>
                        </View>
