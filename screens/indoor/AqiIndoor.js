...
import FrontPageIndoor from '../../component/klaen/FrontPageIndoor';
...
const AqiIndoor = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
          ...
          {/* <FrontPage data={dataHumidity} loading={isLoading} area={'INDOOR AIR'}/> */}
          <FrontPageIndoor />
