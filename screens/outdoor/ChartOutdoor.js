...
import CurrentChart from '../../component/klaen/CurrentChart';
...
const ChartOutdoor = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
          ...
          <CurrentChart loading={isLoading} area={"OUTDOOR AIR"} />
